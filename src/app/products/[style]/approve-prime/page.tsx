...
import { Check, RefreshCcw, MessageSquare, X, Sparkles, AlertCircle } from "lucide-react";
                ...
                <AnimatePresence>
                  {feedback.length > 0 && (
                    ...
                    >
                      ...
                      <p className="text-[11px] text-white/90">{chipPrompts[feedback[feedback.length - 1]] || "Optimizing material realism..."}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
