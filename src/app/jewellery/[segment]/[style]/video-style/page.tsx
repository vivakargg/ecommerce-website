...
export default function JewelleryVideoStyleSelectionPage() {
  ...
  const videoStyles = [
    { id: "shine-closeup", title: "Jewellery Shine Close-up" },
    { id: "slow-pan", title: "Studio Pan" },
    { id: "float-rotate", title: "Floating Rotation" },
    { id: "detail-zoom", title: "Elegant Detail Zoom" }
  ];
          ...
          {isLoading && (
            ...
            >
              ...
              <div className="text-center px-6">
                <h2 className="text-2xl font-bold text-white mb-2 font-manrope italic">Synthesizing Luxury Video</h2>
        ...
        {(!currentProject?.sourceJobId && !isLoading) && (
          ...
          >
            ...
            <p className="text-amber-400/80 text-xs font-medium ml-8">
              Please 
              <button 
                onClick={() => router.push(`/jewellery/${segment}/${styleParam}/approve-prime`)}
